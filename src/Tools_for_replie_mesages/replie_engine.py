...
class ReplierEngine:
    def __init__(self, api_id: int, api_hash: str):
        ...
        self.task_names: List[str] = client_mongodb.get_entry(client_mongodb.collection_for_parser_configs)['task_names']
    ...
    def create_a_task_names(self):
        task_names = client_mongodb.get_entry(client_mongodb.collection_for_parser_configs)['task_names']
        for channel_to in self.channels_to_posts_the_posts:
            ...
            self.task_names = client_mongodb.get_entry(client_mongodb.collection_for_parser_configs)['task_names']
